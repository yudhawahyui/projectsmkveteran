                ...
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                    <div class="d-md-flex">
                        <ol class="breadcrumb ms-auto">
                            <li><a href="/add-siswa" class="fw-normal">Edit Data Siswa</a></li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-5 col-lg-5 col-sm-5">
                    <div class="white-box">
                        <div class="d-md-flex mb-3">
                            <h3 class="box-title mb-0">Edit Data Siswa</h3>
                        </div>
                        <form class="user" action="{{ route('addsiswa.update', $user->id) }}" method="POST"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col">
                                    ...
                                    <input type="number" class="form-control" id="exampleInputEmail"
                                        placeholder="Nomer Handphone" name="no_hp" value="{{ $user->no_hp }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    ...
                                    <input type="number" class="form-control" id="exampleInputPassword"
                                        placeholder="Masukkan NISN" name="nisn" value="{{ $user->nisn }}">
                                </div>
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    <label class="form-label">Jenis Kelamin</label>
                                    <select name="jenis_kelamin" class="form-control form-select" id="">
                                        <option value="{{ $user->jenis_kelamin }}" selected>{{ $user->jenis_kelamin }}
                                        </option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail" placeholder="Sekolah Asal"
                                    name="sekolah_asal" value="{{ $user->sekolah_asal }}">
                            </div>
                            <div class="form-group row">
                                <div class="col">
